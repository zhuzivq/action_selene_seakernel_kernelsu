...
ORIGIN_BOOTIMG_DLINK="https://github.com/zhuzivq/action_selene_seakernel_kernelsu/releases/download/seleneimg/boot_miui12.5.12.img"

# Build
DEVICES_CODE="selene"
DEVICE_DEFCONFIG="sea_selene_defconfig"
